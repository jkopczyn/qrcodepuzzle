...
## To use:
- Clone repository.
- A. If you have a QR code already in mind, move the image (as PNG) into the directory and call `python image_to_puzzle.py <imagefilename>`.
- B. If you have a secret code instead, `./secret_to_puzzle.sh <secret_code>`.
